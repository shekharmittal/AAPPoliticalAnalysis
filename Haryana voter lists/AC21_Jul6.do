...
local SaveFileName "AC21"
import delimited "21-with-groups.csv", varnames(nonames) encoding(UTF-8) clear 
...
import excel "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("Female") firstrow clear
drop Cum
export excel using "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("Female") sheetreplace firstrow(variables)

import excel "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("AgeGroup") firstrow clear
drop Cum
export excel using "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("AgeGroup") sheetreplace firstrow(variables)


import excel "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("Caste") firstrow clear
drop Cum
export excel using "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("Caste") sheetreplace firstrow(variables)

import excel "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("InfluentialHH") firstrow clear
drop Cum
export excel using "C:\Users\shekh\Google Drive\AAP Haryana Data\Haryana voter lists\`SaveFileName'.xlsx", sheet("InfluentialHH") sheetreplace firstrow(variables)
