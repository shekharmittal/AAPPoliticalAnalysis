...
local SaveFileName "AC1"
import delimited "1-with-groups.csv", varnames(nonames) clear


//For AC3
//local SaveFileName "AC3"
//import delimited "3-with-groups.csv", varnames(nonames) encoding(UTF-8) clear 
//drop if v24!=""
//drop v24 v25 v26
//drop if Gender=="SEX"
...
drop SerialCount
save "`SaveFileName'_AggregatedAtPS.dta", replace 
